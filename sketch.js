...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    // Increase Difficulty
    if (score >= 4 && score < 10 && fruitGroup.xEach === 0 && fruitGroup.xEach === 0) {
      fruitGroup.setVelocityXEach(9)
      monsterGroup.setVelocityXEach(10)
    } else if(score >= 10 && fruitGroup.xEach === 0 && fruitGroup.xEach === 0) {
      fruitGroup.setVelocityXEach(11);
      monsterGroup.setVelocityXEach(12);
    } else if(score >= 10 && fruitGroup.xEach === 600 && fruitGroup.xEach === 600) {
      fruitGroup.setVelocityXEach(-11);
      monsterGroup.setVelocityXEach(-12);
    } else if(score >= 4 && score < 10 && fruitGroup.xEach === 600 && fruitGroup.xEach === 600) {
      fruitGroup.setVelocityXEach(-9);
      monsterGroup.setVelocityXEach(-10);
    }
